 ...
 {System.out.println("\t\t\t1\n\n");
  switch(c.month)
  {
   case 1:
   {
    ...
    {
     c.date=c.date-31;
     c.month++;System.out.println(c.date+"\t"+c.month+"\t"+c.year);
    ...
    else if(c.date<=0)
    {
     c.date=c.date+31;
     c.month=12;
	 c.year--;System.out.println(c.date+"\t"+c.month+"\t"+c.year);
	 }
    else
    {
     c.date=c.date;System.out.println(c.date+"\t"+c.month+"\t"+c.year);
    }
   }break;
   case 2:
   {
   ...
   switch(ch1)
   {
    case 1:
    {
     ...
     switch(ch2)
     {
      case 1:
      {
	   ...
	   d=inp.nextInt();
	   c3.date=d;
	   c3.month=c3.year=c1.date=c1.month=c1.year=0;
	   Calculation_1(c3);
	   t2=Calculation_2(c3);
	   c1.date=t1+t2;
      ...
      case 2:
      {
	   ...
	   m=inp.nextInt();
	   c3.month=m;
	   c3.date=c3.year=c1.date=c1.month=c1.year=0;
	   Calculation_1(c3);
	   t2=Calculation_2(c3);
	   c1.date=t1+t2;
	   Calculation_1(c1);
      ...
      case 3:
      {
	   ...
	   y=inp.nextInt();
	   c3.year=y;
	   c3.date=c3.month=c1.date=c1.month=c1.year=0;
	   Calculation_1(c3);
	   t2=Calculation_2(c3);
	   c1.date=t1+t2;
	   Calculation_1(c1);
      ...
      switch(ch3)
      {
	   ...
	   case 2:
	   {
	    ...
	    c2.month=1;
            c2.year=1;
	    Calculation_1(c2);
	    c2.month=c2.month+((c2.year-1)*12);
    ...
    case 3:
    {
     do
     {
      ...
      c1.date=c1.month=c1.year=0;
      c1.date=Calculation_2(c3);System.out.println(c1.date);
      if(c1.date<0)
      {
	   c1.date=c1.date*(-1);
      }
      c1.date=c1.date;
      c1.date=c1.date%7;System.out.println(c1.date);
      switch(c1.date)
      {
